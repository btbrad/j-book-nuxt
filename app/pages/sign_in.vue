      ...
      <div class="glass-card rounded-3xl p-8 shadow-2xl backdrop-blur-xl">
        ...
        <div class="text-center mb-8">
          <div class="inline-block mb-4">
            <div class="w-16 h-16 bg-gradient-to-br from-pink-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-lg animate-pulse-slow">
              <IconAntDesignLoginOutlined class="text-3xl text-white" />
            </div>
          </div>
          <h1 class="text-3xl font-bold text-white mb-2">欢迎回来</h1>
          <p class="text-gray-300 text-sm">登录您的账号继续旅程</p>
        </div>
        ...
        >
          ...
          <div class="text-center text-gray-300 text-sm">
            没有账号？
            <NuxtLink to="/sign_up" class="text-pink-400 hover:text-pink-300 font-semibold transition-colors">
              去注册
            </NuxtLink>
          </div>
        </a-form>
